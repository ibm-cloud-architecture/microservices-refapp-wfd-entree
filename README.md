...
public class EntreeApplication extends Application {
...
[INFO] Failsafe report directory: /Users/user@ibm.com/PurpleCompute/Microprofile/WhatsForDinner/refarch-cloudnative-wfd-entree/target/test-reports/it
[INFO]
[INFO] --- maven-install-plugin:2.4:install (default-install) @ WfdEntree ---
[INFO] Installing /Users/user@ibm.com/PurpleCompute/Microprofile/WhatsForDinner/refarch-cloudnative-wfd-entree/target/WfdEntree-1.0-SNAPSHOT.war to /Users/user@ibm.com/.m2/repository/projects/WfdEntree/1.0-SNAPSHOT/WfdEntree-1.0-SNAPSHOT.war
[INFO] Installing /Users/user@ibm.com/PurpleCompute/Microprofile/WhatsForDinner/refarch-cloudnative-wfd-entree/pom.xml to /Users/user@ibm.com/.m2/repository/projects/WfdEntree/1.0-SNAPSHOT/WfdEntree-1.0-SNAPSHOT.pom
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
...
[INFO] Waiting up to 30 seconds for server confirmation:  CWWKF0011I to be found in /Users/user@ibm.com/PurpleCompute/Microprofile/WhatsForDinner/refarch-cloudnative-wfd-entree/target/liberty/wlp/usr/servers/defaultServer/logs/messages.log
[INFO] CWWKM2010I: Searching for CWWKF0011I in /Users/user@ibm.com/PurpleCompute/Microprofile/WhatsForDinner/refarch-cloudnative-wfd-entree/target/liberty/wlp/usr/servers/defaultServer/logs/messages.log. This search will timeout after 30 seconds.
...
```
[INFO] CWWKM2001I: Invoke command is [/Users/user@ibm.com/PurpleCompute/Microprofile/WhatsForDinner/refarch-cloudnative-wfd-entree/target/liberty/wlp/bin/server, stop, defaultServer].
...
```
Successfully built ab65b2137277
...
==> v1beta1/Deployment
NAME                  DESIRED  CURRENT  UP-TO-DATE  AVAILABLE  AGE
wfdentree-deployment  1        1        1           0          0s
```
...
In the above case, the access url will be `http://192.168.99.100:32021/WfdEntree/rest/entree`.
...
<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/eOrgscreen.png">
</p>

By clicking on the **refarch-cloudnative-wfd-entree**, you can see the below screen.

<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/jenkinsentscreen.png">
</p>
...
<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/eMSBbuildqueue.png">
</p>

Once this is done, Jenkins slave will be called.

<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/ejenkinsslaveinit.png">
</p>

Then the Jenkins slave will pick up the build and initiate the process.

<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/ejenkinsslave%20build.png">
</p>

Then the build will begin and starts running.

<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/ebuild.png">
</p>

Finally your service gets deployed once the build is done.

<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/ecompletedbuild.png">
</p>

To access your service, go to IBM Cloud Private dashboard.
- Go to **Workload > Services > wfdentree-service** and click on it.
- You can see the service like below.

<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/wfdentreeservice.png">
</p>

Click on the **http** link there. You will be redirected to the Server page. Append **/WfdEntree/rest/entree** to the url and you will be able to see the Entree service.

<p align="center">
    <img src="https://github.com/ibm-cloud-architecture/refarch-cloudnative-wfd/blob/microprofile/static/imgs/MSB_jenkins/entreeICP.png">
</p>
